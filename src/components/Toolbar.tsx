...
const TOOLS: ToolDef[] = [
  ...
  { id: 'select', icon: <SquareDashed size={20} />, label: 'Select', shortcut: 'M' },
  { id: 'lasso', icon: <Lasso size={20} />, label: 'Lasso', shortcut: 'Q' },
  { id: 'move', icon: <Move size={20} />, label: 'Move', shortcut: 'V' },
